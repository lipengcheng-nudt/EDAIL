...
sys.path.insert(0, "./")
import os
os.add_dll_directory("C://Users//17534//.mujoco//mujoco210//bin")
...
from edail.edail import EDAIL
from edail.get_policy import get_ppo_policy, get_basic_policy, get_diffusion_policy, get_deep_ddpg_policy, get_deep_sac_policy, get_deep_iqlearn_policy, get_deep_basic_policy
...
def get_setup_dict():
    return {
        ...
        "edail": (EDAIL(), get_ppo_policy),
    }


class EDAILSettings(RunSettings):
...
if __name__ == "__main__":
    print("setting", EDAILSettings())
    run_policy(EDAILSettings())